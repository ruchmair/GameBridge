using UnityEngine;
    ...
    [RequireComponent(typeof (MaruCharacterController))]
    public class MaruControl : MonoBehaviour
    {
        ...
        private MaruCharacterController character; // A reference to the MaruCharacterController on the object
        ...
        private void Start()
        {
            ...
            character = GetComponent<MaruCharacterController>();
        }
